...
function App() {
  ...
  return (
    <div
      dir={direction}
      className="flex h-screen cursor-default select-none bg-content-bg text-text"
    >
      <Toaster
        theme="system"
        toastOptions={{
          ...
          classNames: {
            toast:
              "bg-card border border-separator rounded-lg shadow-lg px-4 py-3 flex items-center gap-3 text-sm",
            title: "font-medium",
      ...
      <SettingsSidebar
        ...
        settings={settings}
      />
      <main className="flex min-w-0 flex-1 flex-col bg-content-bg">
        <div
          className="flex h-[52px] shrink-0 items-center px-[22px] text-[15px] font-bold tracking-[-0.01em]"
          onMouseDown={startWindowDrag}
        >
          {t(SECTIONS_CONFIG[currentSection].labelKey)}
        </div>
        <div className="flex-1 overflow-y-auto px-[26px] pb-[26px] pt-0">

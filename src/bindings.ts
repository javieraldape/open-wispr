 ...
 */
async getLastTranscript() : Promise<Result<string | null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_last_transcript") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async saveTranscriptFix(editedText: string) : Promise<Result<SaveFixResult, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("save_transcript_fix", { editedText }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async previewFix(shownText: string, editedText: string) : Promise<Result<PreviewFixResult, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("preview_fix", { shownText, editedText }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async correctionsList() : Promise<Result<StoredCorrectionDto[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("corrections_list") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async correctionsDelete(heardKey: string) : Promise<Result<boolean, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("corrections_delete", { heardKey }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async correctionsAddManual(heardText: string, correctText: string, verbatim: boolean) : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("corrections_add_manual", { heardText, correctText, verbatim }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async openFixEditor() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("open_fix_editor") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
pasteCompleteEvent: PasteCompleteEvent,
streamPhaseEvent: StreamPhaseEvent,
streamTextEvent: StreamTextEvent
}>({
historyUpdatePayload: "history-update-payload",
pasteCompleteEvent: "paste-complete-event",
...
export type PasteCompleteEvent = { text: string }
 ...
 */
export type PreviewFixResult = { pairs: ([string, string])[]; rewrite_guard: boolean }
 ...
 */
export type StoredCorrectionDto = { id: number; heard_key: string; heard_text: string; correct_text: string;
/**
 * "learned" or "manual".
 */
source: string; verbatim: boolean; created_at: string; last_applied_at: string | null }
/**

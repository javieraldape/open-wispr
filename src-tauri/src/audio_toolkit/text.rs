...
///
/// `pub` (fork change): reused by the corrections engine's apply pass so both
/// correction systems share one casing behavior. See NOTICE.md.
pub fn preserve_case_pattern(original: &str, replacement: &str) -> String {
